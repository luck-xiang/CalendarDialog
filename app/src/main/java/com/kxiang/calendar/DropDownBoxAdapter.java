...
import com.kxiang.calendar.rlv.BaseRecycleViewAdapter;
 ...
 */
public class DropDownBoxAdapter extends BaseRecycleViewAdapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new RadioHolder(inflater.inflate(R.layout.item_drop_down_box, parent, false));
    }
